...
module.exports = function (app) {
  ...
  const model = sequelize.define('subregions',
    {
  ...
  const Subregion = Object.assign(model,{
    ...
    listAll(filter,params){
      ...
      return new Promise((resolve,reject)=>{
        ...
        const selWithParentCode = query.parent_code ? ` AND ${this._name}.parent_code = ${query.parent_code} ` : '';
        ...
        const arr_type_condition = {
          ...
          "count":`
              ...
              WHERE (${this._name}.json LIKE '%${ this._key }%') ${selWithDate + selWithIsDel + selWithParentCode }
          `,
          "all": `
                  FROM ${this._name}
                  LEFT JOIN users on users.id = ${this._name}.creator_id
