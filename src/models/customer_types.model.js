  ...
  Object.assign(model,{
    ...
    listAll(filter,params){
      ...
      return new Promise((resolve,reject)=>{
        ...
        let sql = ` SELECT
                      ${this._name}.id,
                      LOWER(${this._name}.code) as code,
                      ${this._name}.name,
                      ${this._name}.decription,
                      ...
                      ${this._name}.color_code,
                      ${this._name}.ref_price,

                      count(distinct customers.id) as total_customer,
        ...
        const arr_type_condition = {
          ...
          "all": `
                  FROM ${this._name}
                  LEFT JOIN users on users.id = ${this._name}.creator_id
                  LEFT JOIN customers on  customers.type = ${this._name}.code
                  WHERE (${this._name}.json LIKE '%${ this._key }%' OR ${this._name}.code LIKE '%${this._key}%')  ${selWithDate + selWithIsDel    }
