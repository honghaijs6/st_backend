...
module.exports = {
  before: {
    ...
    create: [
      authenticate('jwt'),
      defaultSchemaPost({Helper,schema:['person_name','person_address','type','bill_account_id']}), /* this guy return err: on missing Default field */
      //buildJsonFieldPost({ Helper ,schema :['person_name','person_address'] }), // This guy create json field stringify
    ...
    update: [
      ...
      //buildJsonFieldPost({ Helper ,schema :['person_name','person_address'] }),
