...
module.exports = {
  before: {
    ...
    create: [
      ...
      defaultSchemaPost({Helper,schema:['name','email']}), /* this guy return err: on missing Default field */
      //buildJsonFieldPost({ Helper ,schema :['name'] }), // This guy create json field stringify
    ...
    update: [
      ...
      //buildJsonFieldPost({ Helper ,schema :['name'] }),
      defaultKeyFieldPut(), /* date_modified, log =[change ] */
      hashPassword(),

    ],
    patch: [ hashPassword() ],
    remove: [authenticate('jwt'), defaultSchemaDel() ] //delInSchema() /*  this gus add field : date_deleleted - deleted_by -   */ ]
  },
