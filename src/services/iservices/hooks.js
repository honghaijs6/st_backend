...
module.exports = {
  before: {
    ...
    create: [
      authenticate('jwt'),
      defaultSchemaPost({Helper,schema:['type','belong_user']}), /* this guy return err: on missing Default field */
      //buildJsonFieldPost({ Helper ,schema :['type','content_issue'] }), // This guy create json field stringify
    ...
    update: [
      ...
      //buildJsonFieldPost({ Helper ,schema :['customer_info','constructor_team'] }),
