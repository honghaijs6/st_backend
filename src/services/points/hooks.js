...
module.exports = {
  before: {
    ...
    create: [
      ...
      //buildJsonFieldPost({ Helper ,schema :['code', 'buyer','name','address','dist','city','address_xhd','tax_no','contact_name','phone','email','username',''] }), // This guy create json field stringify
