...
module.exports = {
  before: {
    ...
    create: [
      ...
      authenticate('jwt'),
      defaultSchemaPost({Helper,schema:['name','tax_no','phone']}), /* this guy return err: on missing Default field */
      //buildJsonFieldPost({ Helper ,schema :['name','tax_no','phone'] }), // This guy create json field stringify
    ...
    update: [
      ...
      //buildJsonFieldPost({ Helper ,schema :['name','tax_no','phone'] }),
