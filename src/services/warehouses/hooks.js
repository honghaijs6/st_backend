...
module.exports = {
  before: {
    ...
    create: [
      authenticate('jwt'),
      defaultSchemaPost({Helper,schema:['code','name','address']}), /* this guy return err: on missing Default field */
      buildJsonFieldPost({ Helper ,schema :['code','name','address'] }), // This guy create json field stringify
