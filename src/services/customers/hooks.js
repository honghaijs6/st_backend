...
module.exports = {
  before: {
    ...
    create: [
      authenticate('jwt'),
      defaultSchemaPost({Helper,schema:['code','name','address','tax_no','email','phone','contact_name']}), /* this guy return err: on missing Default field */
      //buildJsonFieldPost({ Helper ,schema :['code','name','address','tax_no','email','phone','contact_name'] }), // This guy create json field stringify
    ...
    update: [
      ...
      //buildJsonFieldPost({ Helper ,schema :['code','name','address','tax_no','email','phone','contact_name'] }),
